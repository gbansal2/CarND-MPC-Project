...
vector<double> MPC::Solve(Eigen::VectorXd& x0, Eigen::VectorXd& coeffs) {
  ...
  int inc = N/7;  //Used for showing the path - 7 intervals or 8 points
  ...
  return {solution.x[x_start + 1],   solution.x[y_start + 1],
          ...
          solution.x[x_start + 1],   solution.x[x_start + inc],
          solution.x[x_start + 2*inc],   solution.x[x_start + 3*inc],
          solution.x[x_start + 4*inc],   solution.x[x_start + 5*inc],
          solution.x[x_start + 6*inc],   solution.x[x_start + 7*inc],
          solution.x[y_start + 1],   solution.x[y_start + 1*inc],
          solution.x[y_start + 2*inc],   solution.x[y_start + 3*inc],
          solution.x[y_start + 4*inc],   solution.x[y_start + 5*inc],
          solution.x[y_start + 6*inc],   solution.x[y_start + 7*inc]
  };
}
